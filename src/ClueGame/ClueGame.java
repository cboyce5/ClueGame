...
public class ClueGame extends JFrame{
	...
	public ClueGame() {
		...
		controlGUI = board.getControlGUI();
		controlGUI.getNextPlayerButton().addActionListener(new NextPlayerListener());
		controlGUI.getAccusationButton().addActionListener(new accusationListener());
		setTitle("Clue Game");
